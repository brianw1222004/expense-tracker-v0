...
const STRINGS = {
  en: {
    ...
    'budget.setTitle': 'Set up budgets',
    'budget.setHint': 'Pick a currency and set monthly spending limits',
  ...
  zh: {
    ...
    'budget.remaining': '剩餘',
    'budget.overBy': '超支',
    'budget.setTitle': '設定預算',
    'budget.setHint': '選擇貨幣並設定每月支出上限',
    'budget.edit': '編輯預算',
  ...
  es: {
    ...
    'budget.setTitle': 'Configurar presupuestos',
    'budget.setHint': 'Elige una moneda y fija límites de gasto mensuales',
