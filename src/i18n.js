...
const STRINGS = {
  en: {
    ...
    'currency.chooseHint': 'Search and select any supported currency.',
    'currency.search': 'Search currency, e.g. USD, Yen, Euro',
    'currency.noResults': 'No currencies match.',
    ...
    'income.title': 'Income & Balance',
    'income.balance': 'Balance',
    'income.vsLastMonth': 'vs last month',
    'income.vsMonth': 'vs {month}',
    'income.income': 'Income',
    'income.expenses': 'Expenses',
    'income.backToCurrent': 'Back to current',
    'income.trend': 'Income vs Expenses',
    'income.months3': '3M',
    'income.months6': '6M',
    'income.empty': 'No income yet',
    'income.emptyHint': 'Add your income to see your balance and trend.',
  ...
  zh: {
    ...
    'currency.chooseHint': '搜尋並選擇任何支援的貨幣。',
    'currency.search': '搜尋貨幣，例如 USD、日圓、歐元',
    'currency.noResults': '找不到符合的貨幣。',
    ...
    'income.title': '收入與結餘',
    'income.balance': '結餘',
    'income.vsLastMonth': '與上月相比',
    'income.vsMonth': '與 {month} 相比',
    'income.income': '收入',
    'income.expenses': '支出',
    'income.backToCurrent': '回到目前',
    'income.trend': '收入與支出',
    'income.months3': '3個月',
    'income.months6': '6個月',
    'income.empty': '尚無收入',
    'income.emptyHint': '新增收入即可看到結餘與趨勢。',
    'income.add': '新增收入',
    'income.added': '已新增收入',
    'income.edit': '編輯收入',
    'income.amount': '金額',
  ...
  es: {
    ...
    'currency.chooseHint': 'Busca y selecciona cualquier moneda compatible.',
    'currency.search': 'Buscar moneda, p. ej. USD, Yen, Euro',
    'currency.noResults': 'Ninguna moneda coincide.',
    ...
    'income.title': 'Ingresos y saldo',
    'income.balance': 'Saldo',
    'income.vsLastMonth': 'vs mes anterior',
    'income.vsMonth': 'vs {month}',
    'income.income': 'Ingresos',
    'income.expenses': 'Gastos',
    'income.backToCurrent': 'Volver al actual',
    'income.trend': 'Ingresos vs Gastos',
    'income.months3': '3M',
    'income.months6': '6M',
    'income.empty': 'Aún no hay ingresos',
    'income.emptyHint': 'Añade tus ingresos para ver tu saldo y tendencia.',
    'income.add': 'Añadir ingreso',
    'income.added': 'Ingreso añadido',
    ...
    'add.typeExpense': 'Gasto',
    'add.typeIncome': 'Ingreso',
