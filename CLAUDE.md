...
- **Income** — deleted end-to-end (UI first, then the data/sync layer in 2026-07). Only legacy wipes remain in `clearQueues`/`clearUserStorage`/`deleteAccount`, for old installs. No `income.*` i18n keys.
